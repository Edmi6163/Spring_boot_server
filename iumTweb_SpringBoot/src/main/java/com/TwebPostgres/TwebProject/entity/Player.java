package com.TwebPostgres.TwebProject.entity;
...
public class Player {
    /*
    public Player(Integer playerId, String firstName, String lastName, String name, Integer lastSeason, Integer currentClubId, String playerCode, String countryOfBirth, String cityOfBirth, String countryOfCitizenship, LocalDate dateOfBirth, String subPosition, String position, String foot, Integer heightInCm, Integer marketValueInEur, Integer highestMarketValueInEur, LocalDate contractExpirationDate, String agentName, String imageUrl, String url, String currentClubDomesticCompetitionId, String currentClubName, Double id, Long id_key) {
...
*/
    // @ColumnDefault("nextval('player_player_id_seq'")
    ...
    private Double id;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY) //incrementa automaticamente la chiave primaria
    private Long id_key;
